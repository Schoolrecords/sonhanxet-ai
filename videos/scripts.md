...
## 🎙️ Chuẩn bị chung cho cả 3 video

### Phần mềm quay (chọn 1)

| Tool | Đề xuất cho | Link |
|---|---|---|
| **Loom** | Lần đầu, đơn giản nhất | loom.com (Chrome extension) |
| **OBS Studio** | Pro, nhiều tùy chọn | obsproject.com |
| **PowerPoint Recording** | Quen Office | Có sẵn trong PowerPoint |

### Chuẩn bị môi trường quay
...
### Lớp test dữ liệu giả

Tạo trên Vnedu (hoặc dùng lớp thật nhưng **đổi tên HS bằng Find & Replace browser**):
- Nguyễn Văn An — T+
- Trần Thị Bình — T
- Lê Hoàng Cường — T
- Phạm Mai Dung — H
- Vũ Minh Đức — T+
- (... thêm 30 HS khác với tên giả)

### Tone giọng

- **Thân thiện** như nói chuyện với đồng nghiệp
- **Vừa phải** — không quá nhanh, không quá chậm
- **Tự nhiên** — sai chỗ nào quay lại, không cần perfect
- **Tránh đọc kịch bản** — nói thành ý, không thuộc lòng

---

## 🎬 VIDEO 1 — "Bắt đầu trong 90 giây"

**Thời lượng**: 1:30
**Mục đích**: Hook người xem lần đầu — cho thấy giá trị ngay
**Đặt làm featured video trên website**

### Cấu trúc tổng

| Đoạn | Thời gian | Nội dung |
|---|---|---|
| Hook | 0:00–0:10 | Vấn đề cuối kỳ — 3-4 tiếng viết nhận xét |
| Demo | 0:10–1:10 | Cài → mở Vnedu → sinh → áp dụng |
| Đóng | 1:10–1:30 | Cam kết bảo mật + CTA |

### Chi tiết từng cảnh

#### 📺 Cảnh 1 (0:00–0:10) — Hook
...
#### 📺 Cảnh 4 (0:50–1:10) — Sinh + Áp dụng

**Màn hình**:
- Bấm nút vàng "Sinh nhận xét cho 35 HS →"
- Sidebar hiện preview các nhận xét (5-6 cards)
- Bấm "Áp dụng vào Vnedu"
- Các ô nhận xét trên Vnedu được điền tự động
- Bấm Lưu của Vnedu

**Lời thuyết minh**:
> *"Bấm một nút — AI sinh nhận xét cho cả lớp. Thầy cô xem trước, nếu câu nào chưa ưng có thể chỉnh tay luôn trong sidebar. Bấm 'Áp dụng', toàn bộ chữ được ghi vào ô nhận xét của Vnedu. Bấm Lưu — xong. Từ đầu đến cuối: chưa đến 5 phút."*

#### 📺 Cảnh 5 (1:10–1:30) — Bảo mật + CTA

**Màn hình**: Đóng Vnedu → mở section "Cam kết bảo mật" trên website

**Lời thuyết minh**:
> *"Quan trọng: thông tin học sinh không gửi đi đâu cả. Mọi nhận xét sinh ra ngay trong trình duyệt của thầy cô, đóng tab là biến mất. Mã nguồn mở, ai cũng kiểm tra được. Tải về tại Chrome Web Store hoặc vào sonhanxet-ai.vercel.app. Hẹn thầy cô ở video chi tiết tiếp theo!"*

---

## 🎬 VIDEO 2 — "Sinh nhận xét môn học cho cả lớp 35 HS"

**Thời lượng**: 2:15
**Mục đích**: Tutorial chi tiết cho người đã cài extension
**Tag**: Nhận xét môn
...
| Đoạn | Thời gian | Nội dung |
|---|---|---|
| Intro | 0:00–0:15 | Giới thiệu nội dung video |
| Mở Vnedu | 0:15–0:35 | Đến đúng trang Sổ nhận xét |
| Sinh nhận xét | 0:35–1:15 | Bấm nút, AI làm việc |
| Chỉnh sửa | 1:15–1:45 | Cách edit từng câu trong sidebar |
| Áp dụng + Lưu | 1:45–2:05 | Ghi vào Vnedu |
| Đóng | 2:05–2:15 | Tips + chuyển sang video NLPC |
...
#### 📺 Cảnh 2 (0:15–0:35) — Mở Vnedu

**Màn hình**:
- Mở Chrome, gõ vnedu.vn
- Đăng nhập (làm nhanh, có thể fade nhanh phần này)
- Vào Sổ điểm → Sổ nhận xét

**Lời thuyết minh**:
> *"Đầu tiên, vào Vnedu như bình thường, đăng nhập. Vào menu Sổ điểm — chọn Sổ nhận xét. Chọn khối, lớp, môn, học kỳ. Đợi danh sách học sinh load xong."*

#### 📺 Cảnh 3 (0:35–0:55) — Sidebar xuất hiện
...
**Màn hình**:
- Click nút vàng "Sinh nhận xét cho 35 HS →"
- Animation loading nhẹ (~1 giây)
...
**Màn hình**:
- Scroll sidebar xem qua 5-6 cards
- Click vào 1 card (vd "Trần Thị Bình")
- Card mở ra với textarea, sửa nội dung
- Sau khi sửa, card có dấu "✏️ Đã chỉnh"

**Lời thuyết minh**:
> *"Trong sidebar, thầy cô thấy preview của tất cả nhận xét. Đây là Nguyễn Văn An — T+ — hoàn thành tốt môn Toán, tính toán nhanh. Trần Thị Bình — T — nắm vững kiến thức cơ bản... Câu nào chưa ưng, click vào card để chỉnh trực tiếp. AI tôn trọng tuyệt đối chỉnh sửa của giáo viên."*

#### 📺 Cảnh 6 (1:45–2:05) — Áp dụng + Lưu

**Màn hình**:
- Bấm nút "Áp dụng 35 nhận xét vào Vnedu →"
- Toast notification xanh "✓ Đã áp dụng 35 nhận xét"
- Cuộn xuống bảng Vnedu: cột Nhận xét đã có chữ
- Bấm nút Lưu của Vnedu

**Lời thuyết minh**:
> *"Khi đã hài lòng, bấm 'Áp dụng' — chỉ một click, toàn bộ 35 nhận xét được ghi vào các ô textarea của Vnedu. Cuối cùng, đừng quên bấm nút 'Lưu' của Vnedu để hệ thống lưu lại. Xong!"*

#### 📺 Cảnh 7 (2:05–2:15) — Đóng
...
## 🎬 VIDEO 3 — "Sinh nhận xét Năng lực & Phẩm chất (NL/PC)"

**Thời lượng**: 3:00
**Mục đích**: Tutorial cho module NL/PC — phần khó nhất theo TT27
**Tag**: Nhận xét NL/PC
...
**Màn hình**:
- Chuột hover lên 1 badge (vd Năng lực Khoa học, đang là T)
- Click vào badge → dropdown nhỏ xuất hiện với 3 option: T (current ✓), Đ, C
- Click vào option Đ
- Badge đổi màu từ xanh lá → cam
- Tag góc đổi từ "AI ✨" thành "GV chỉnh"

**Lời thuyết minh**:
> *"Nếu thầy cô không đồng ý với mức AI gợi ý — ví dụ học sinh này điểm Khoa học tốt nhưng thực tế trong lớp hay xao nhãng — chỉ cần click vào badge. Dropdown nhỏ hiện ra với 3 lựa chọn T - Đ - C. Click chọn lại Đ thay vì T. Badge chuyển màu cam, tag thay đổi thành 'GV chỉnh' — hệ thống ghi nhận đây là quyết định của giáo viên, không phải AI."*

#### 📺 Cảnh 6 (2:25–2:45) — Áp dụng + Lưu

**Màn hình**:
- Scroll xuống cuối form Vnedu
- Bấm nút "Lưu" của Vnedu
- Hiện thông báo "Đã lưu thành công"
...
**Màn hình**:
- Hiển thị danh sách 35 HS, vài HS đầu đã có dấu tích, các HS còn lại chưa
...
## 📋 Checklist tổng trước khi quay

Trước mỗi buổi quay, check qua 1 lần:
...
1. **Edit nhẹ** trong Loom/Camtasia: cắt phần đầu (đếm) và đuôi (lúng túng)
2. **Export** ra MP4 1080p (hoặc 720p nếu file quá nặng)
3. **Upload lên YouTube**:
   - Visibility: **Không công khai** (Unlisted) — chỉ ai có link mới xem được
   - Title: VD `Sổ nhận xét - AI · Video 1: Bắt đầu trong 90 giây`
   - Description: paste link website + 1 câu mô tả
4. **Copy 11 ký tự ID** từ URL YouTube
5. **Gửi cho tôi** 3 ID (1 dòng/ID), tôi sẽ update website + push GitHub → Vercel auto deploy

---

## 💡 Lời khuyên cuối

- **Không cần perfect lần đầu**. Quay nháp 1 lần để quen, sau đó quay thật.
- **Nếu vấp**, đừng dừng — tiếp tục nói, sau edit cắt đoạn đó.
- **Mỗi video chia 2-3 lần quay nếu mệt** — sau đó ghép trong editor.
- **Mặc áo có cổ + áo trơn màu nhẹ** nếu có quay webcam (mặc dù style đề xuất không cần webcam).
- **Sau khi upload YouTube, xem lại 1 lượt** trước khi gửi link cho tôi — đảm bảo không có chỗ nào lộ tên HS thật.

Chúc thầy quay vui và tự nhiên!
